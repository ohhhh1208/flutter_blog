...
class ImageHelper {
  ...
  static Widget error(
      {required double width, required double height, double? size, DefaultImageHolder? defaultImageHolder}) {
    if (DefaultImageHolder.avatar == defaultImageHolder) {
      return SvgPicture.asset(
        MyImages.ic_default_avatar,
        width: width,
        height: height,
      );
    } else if (DefaultImageHolder.articleCover == defaultImageHolder) {
      return SvgPicture.asset(
        MyImages.ic_image_error,
        width: width,
        height: height,
      );
    } else {
